...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, Sparkles, ChevronRight, Calendar, CheckCircle } from "lucide-react";
...
function ModernLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Login successful! Welcome back to KINSI!`);
  ...
  const handleGoogleSuccess = () => {
    ...
    // Here you would integrate with Google OAuth API
    // For now, we'll simulate a successful login
    alert(`Google login successful! Welcome back to KINSI!`);
    setShowDashboard(true);
  };
  ...
  const handleFacebookSuccess = () => {
    ...
    // Here you would integrate with Facebook OAuth API
    // For now, we'll simulate a successful login
    alert(`Facebook login successful! Welcome back to KINSI!`);
    setShowDashboard(true);
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200">
        <div className="text-center bg-white p-8 rounded-2xl shadow-xl">
          <h2 className="text-2xl font-bold text-orange-600 mb-4">Welcome to Your Dashboard!</h2>
          <p className="text-gray-600 mb-4">Login successful. Dashboard would load here.</p>
          <button 
